        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="simpleLetter">
              <fo:flow flow-name="xsl-region-body">
                 <fo:block>
						<fo:external-graphic  src="url(file:///SNRLogo.jpg)" />
				 </fo:block>
                      ...
                      <fo:table table-layout="fixed" width="100%" border-collapse="separate">    
						...
						<fo:table-column column-width="0cm"/>
                            ...
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Identificador</fo:block>
                              </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Nombre del Documento</fo:block>
                            </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Tipo Documental</fo:block>
                            </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Fecha de Creacion</fo:block>
                              </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Fecha de Incorporacion</fo:block>
                            </fo:table-cell>
							<fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Huella</fo:block>
                            </fo:table-cell>
			                <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Funcion Resumen</fo:block>
                              </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Orden Documento </fo:block>
                            </fo:table-cell>
							<fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Numero de Folios</fo:block>
                            </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Total Acumulado Folios</fo:block>
                            </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Formato</fo:block>
                            </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Tamaño</fo:block>
                              </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
                                <fo:block font-weight="bold">Origen</fo:block>
                            </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="tableBorder">
